...
function randomQuoteGenertor(event){
    quotes = [
        {
    ...
    h1.innerText = quotes[index].quoteAuthor;
    p.innerText = quotes[index].quoteText;
    p.style.color = randomColorGenerator();
...
button.addEventListener("click",randomQuoteGenertor);
